                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        <div class="card-header">
                            <h2 class="card-title mb-2">Welcome Nguyễn Đình Duy</h2>
                            <span class="d-block mb-4 text-nowrap">Admin</span>
                        </div>
                        <br><br>
                        <!--  Author Name: Nguyễn Đình Duy.
                        GigHub Link: https://github.com/dev-mhrony
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="col-md-6">
                                    <h1 class="display-6 text-primary mb-2 pt-4 pb-1">Admin Panel</h1>
                                    <small class="d-block mb-3"><br>Manage Website here</small>
                                    <br>
                                    <br>
                                    <a href="http://localhost/Live-News-Portal-in-PHP/index.php" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                                </div>
                                <div class="col-md-6">
